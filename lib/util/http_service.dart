...
class HttpService {
  ...
  Future<http.Response> post(String path, dynamic body) async {
    return await http.post(Uri.parse(Constants.baseUrl + path), headers: _headers, body: body);
  }

  Future<http.Response> put(String path, dynamic body) async {
    return await http.put(Uri.parse(Constants.baseUrl + path), headers: _headers, body: body);
  }
